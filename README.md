...
Javascript는 주로 웹 브라우저에서 동적인 페이지를 구성해주기 위한 언어입니다. 최근엔 용도가 늘어나 Node.js와 같이 서버 프로그래밍에도 사용하긴 하지만 기본은 동적 웹 페이지 구성을 위한 언어입니다. 참고로 Javascript는 위의 Java 언어와 관련이 없습니다. Java 언어를 스크립트 언어로 만든 것이 절대 아니므로 Java와 호환되지 않으니 혼동하지 마시기 바랍니다.
