...
가장 대표적인 공부법은 아무래도 책을 보고 개념을 숙지하며 중간에 나오는 예제들을 따라쳐서 코드에 익숙해지는 것입니다. 해당 방식은 스스로 학습하고 혼자 생각하는 것을 선호하는 분들에게 잘 맞습니다. 다른 방식들과 비교하여 단기적인 학습 속도는 조금 느릴 수 있지만, 장기적으로 보면 가장 내공을 튼실히 할 수 있는 방식이라고 생각합니다. 순수 공부에 투자하는 기간이 3년이 넘어가는 컴퓨터 전공자 저학년들 혹은 중고등학생 분들은 힘들더라도 해당 방법으로 시도해보길 추천합니다.  
다만, 해당 방식의 함정은 책 선정에 있습니다. 어느정도 경지에 오르면 책의 내용이 잘못되지는 않았는지 혹은 믿을만 한지 판별도 할 수 있겠지만 학습을 시작한지 얼마 안 된 분들은 그런 내용을 판별하기 어렵습니다. 그러한 상황에서 오개념이 있는 책으로 열심히 학습하고 나면 자신이 알고 있는 내용이 잘 못 되었는지도 모르고 실수를 하거나 남에게 똑같이 가르칠 수도 있습니다. 많은 국내의 베스트셀러 서적들이 이러한 내용 오류를 담고 있어서 가끔 문제가 되고는 합니다.  
참고로 C언어를 예로 들면 함수의 인자로 포인터를 넘기는 것을 call by reference라고 알고 있거나, ++i는 변수가 먼저 증가하는 것이고 i++는 나중에 증가하는 것이다 라고 알고 있다면 본인도 잘 못 알고 있는 것입니다. 이 경우 C언어로 일해야하는 상황이라면 위에 있는 자료로 다시 학습하기를 권장합니다. (개인적으로 이런 식으로 잘 못 알고 있는건 학습자의 잘못이 아니라 공부한 서적 혹은 가르쳐준 사람의 잘못이라고 생각합니다.)

다른 대표적인 방법으로는 학원에 다니는 것이 있습니다. 많은 비전공자 분들이 해당 방식으로 입문하시는거 같습니다.  
국비 지원 학원, 기업 교육 타겟 캠퍼스나 최근 성행하는 부트 캠프, 온라인 학원 등 종류도 다양합니다.  
당연하지만 이런 학원의 특성으로는 강사 운을 굉장히 많이 탑니다. 전문적으로 알고 있는 잘 가르치는 강사 분을 만난다면 정말 좋겠지만 그러지 못 한 경우도 수 없이 많습니다.  
그리고 학원은 영업을 해야 하기 때문에 입 발린 소리를 굉장히 잘 합니다. 영업 실장의 입담은 잘 모르는 분들을 혹하게 만들기 쉽습니다. 그들은 해당 업계의 굉장한 전문가 처럼 위장하는 말빨을 패시브로 가지고 있습니다.  
심지어 어디는 취업 못 하거나 취업을 하더라도 연봉이 적으면 학원비를 받지 않겠다고 하면서까지 꼬시는 곳도 있을 겁니다. 하지만 이런 말들에 현혹되면 안됩니다.  
개인적으로 학원을 추천하지는 않지만, 혼자서 공부하는게 힘들다던지 당장 취업할 실력이 없고 커리어 공백으로 인한 패널티가 두렵다던지 등 다양한 상황으로 학원을 다니는게 나은 상황이 있을 수 있습니다.  
그런 분들을 위해 좋은 학원을 고르는 방법을 적고 싶지만, 실제로 강의를 들어보지 않는 이상 해당 강의가 정말 좋을지는 알 수가 없습니다.  
따라서, 학원을 수료하고 개발자로 일하고 있는 선배(?)분들에게 물어보는 것이 가장 좋겠지만 현실적으로 그런 분들을 찾아내서(?) 이야기해보기가 쉽지 않습니다. 심지어 그 분들 수료 후에 강사가 바뀌어 강의 퀄리티도 바뀌는 경우가 비일비재 하구요.  
결국 학원은 어느 정도 운이 작용합니다. 만약 다니실거면 해당 사항은 고려해야할 것입니다. 그리고 학원 강의 듣고 시키는 것만 한다고 다 되는 것이 아니고 배운 걸 체화하며 부족한걸 추가로 공부하는 등 본인 공부가 중요하다는 것은 말할 것도 없을거 같습니다.  
마지막으로, 아무리 운이고 뭐가 어쨋고 간에 그래도 학원을 좀 골라주세요 한다면 XX뱅크, XX스크나 인터넷에 광고가 심한 학원은 되도록 피하는게 좋습니다.  
애초에 제가 학원을 다니거나 강의를 들어본 적이 없기에 어떤 학원을 추천드리긴 어렵겠으나 비트교육센터나 쌍용교육센터같은 곳은 어느정도 괜찮다는 소문을 들어보긴 했으니 참고만 해주시기 바랍니다.  
만약 이 글을 보고 있는 시니어 개발자 분들 중 학원을 수료하여 일을 하고 있는데 자신이 다녔던 학원이 괜찮았다 하는 분들이 계신다면 PR이나 Issue등록 해주셔도 감사할 것 같습니다.
