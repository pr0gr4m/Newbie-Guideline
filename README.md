...
* [GoF의 디자인 패턴](http://www.yes24.com/Product/Goods/17525598) : 디자인 패턴의 바이블입니다. 참고로 GoF는 Gang of Four이라고 불리는 Gamma, Helm, Johnson, Vlissides를 줄인 것입니다. 디자인 패턴을 처음 공부하시는 분들 보다는, 디자인 패턴을 한번 정도 공부한 적이 있고 이제 실제 코드에 적용을 하려고 할 때 레퍼런스가 필요한 경우 해당 서적을 참고하는 것을 추천드립니다. 참고로 C++ 언어를 기반으로 작성되어 있습니다.
